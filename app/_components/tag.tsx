...
const tag_color = {
	...
	flow: 'border-cyan-300 text-cyan-300',
	mind: 'border-purple-400 text-purple-400',
	sermon: 'border-pink-300 text-pink-300',
	TMS: 'border-amber-300 text-amber-300',
	tms: 'border-amber-300 text-amber-300',
	ytube: 'border-red-500 text-red-500',
	art: 'border-yellow-400 text-yellow-400',
